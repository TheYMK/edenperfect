  ...
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1559599101-f09722fb4948?w=1920&q=80')`,
        }}
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <AnimatedSection>
          <div className="inline-flex items-center gap-3 mb-6">
            ...
            <span className="font-inter text-xs sm:text-sm tracking-[0.3em] uppercase text-[#B5903E]">
              Réservation en ligne
            </span>
            <div className="h-px w-12 gold-separator" />
          </div>

          <h2 className="font-cormorant text-4xl sm:text-4xl md:text-7xl font-bold text-white leading-tight mb-6">
            Prenez rendez-vous avec
            <span
              className="block"
              style={{
                background:
                  "linear-gradient(135deg, #B5903E, #D4B87A, #B5903E)",
          ...
          <p className="font-inter text-base text-white/60 tracking-wide mb-10 max-w-xl mx-auto">
            Réservez votre soin en ligne 24h/24, gratuitement, avec confirmation
            immédiate.
          </p>
