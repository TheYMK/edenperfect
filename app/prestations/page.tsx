...
export default function PrestationsPage() {
  const [activeCategory, setActiveCategory] = useState(DEFAULT_PRESTATION_CATEGORY);
...
function ServiceCard({ service, index }: { service: PrestationService; index: number }) {
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <span className="font-cormorant text-2xl font-light text-[#B5903E]">{service.price}</span>
      </div>

      <div className="flex-1">
        <h3 className="font-cormorant text-lg font-medium text-[#2C2016] leading-snug mb-2">
          {service.name}
        </h3>
